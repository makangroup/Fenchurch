    ...
    public partial class SettingModelFactory : ISettingModelFactory
    {
        ...
        public virtual CatalogSettingsModel PrepareCatalogSettingsModel()
        {
            ...
            if (storeId > 0)
            {
                ...
                model.ShowFeaturedProductOnHomepage_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.ShowFeaturedProductOnHomepage, storeId);
                model.NumberOfFeaturedProductsOnHomepage_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.NumberOfFeaturedProductsOnHomepage, storeId);

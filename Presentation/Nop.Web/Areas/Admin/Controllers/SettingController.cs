...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
    {
        ...
        public virtual IActionResult Catalog(CatalogSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.ShowFeaturedProductOnHomepage, model.ShowFeaturedProductOnHomepage_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.NumberOfFeaturedProductsOnHomepage, model.NumberOfFeaturedProductsOnHomepage_OverrideForStore, storeScope, false);

...
namespace Nop.Web.Infrastructure.Cache
{
    public static partial class NopModelCacheDefaults
    {
        ...
        public static CacheKey HomepagefeaturedProductsIdsKey => new CacheKey("Nop.pres.featuredproducts.homepage-{0}", HomepagefeaturedProductsIdsPrefixCacheKey);
        public static string HomepagefeaturedProductsIdsPrefixCacheKey => "Nop.pres.featuredproducts.homepage";
